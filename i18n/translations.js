...
const en = {
  ...
  podiumJoseSubtitle: "Highest Jose’s Coefficient. Statistically less embarrassing.",
  podiumDatasTitle: "Datas Diff: Congrats, You Counted",
  podiumDatasSubtitle: "Hands scored minus hands conceded. Math!",
  podiumPointsTitle: "Point Hoarder",
  podiumPointsSubtitle: "You took more points than you gave. Adorable.",
  podiumPphTitle: "Efficiency Theater",
  podiumPphSubtitle: "Points-per-hand differential. Style points optional.",
  podiumPollosTitle: "Chicken Distributor",
  podiumPollosSubtitle: "Most pollos delivered. Cluck responsibly.",
  podiumPolloRateTitle: "Poultry Per Appearance",
  podiumPolloRateSubtitle: "Chickens per game. Consistency is a virtue.",
  podiumZapatosTitle: "Footwear Philanthropist",
  podiumZapatosSubtitle: "Most zapatos gifted to the opposition.",
  podiumZapatoRateTitle: "Shoes Per Capita",
  podiumZapatoRateSubtitle: "Zapato rate. Walk softly, strike often.",
  podiumGamesTitle: "Spreadsheet Padding Champion",
  podiumGamesSubtitle: "Most games logged. Volume is a lifestyle.",
  podiumHandsTitle: "Deal Me In, Forever",
  podiumHandsSubtitle: "Most hands played. The tiles know your name.",
  podiumBestLoserTitle: "Best Loser",
  podiumBestLoserSubtitle: "Most games lost. Participation in defeat.",
  podiumKeepsComingTitle: "Keeps Coming Back",
  podiumKeepsComingSubtitle:
    "Most games among L ≥ W. Optimism is undefeated. You aren’t.",
  podiumPollosEatenTitle: "Free-Range Victim",
  podiumPollosEatenSubtitle: "Most pollos received. Free chicken, expensive dignity.",
  podiumZapatosEatenTitle: "Walk of Shame Leaderboard",
  podiumZapatosEatenSubtitle: "Most zapatos collected. Fashionably defeated.",
...
const es = {
  ...
  podiumJoseSubtitle: "Mayor Coeficiente de José. Menos vergüenza estadística.",
  podiumDatasTitle: "Diff de Datas: Felicidades, Contaste",
  podiumDatasSubtitle: "Manos a favor menos manos en contra. ¡Matemáticas!",
  podiumPointsTitle: "Acaparador de Puntos",
  podiumPointsSubtitle: "Más puntos a favor que en contra. Qué tierno.",
  podiumPphTitle: "Teatro de la Eficiencia",
  podiumPphSubtitle: "Diferencia de puntos por mano. El estilo es opcional.",
  podiumPollosTitle: "Distribuidor de Pollos",
  podiumPollosSubtitle: "Más pollos repartidos. Cloc con responsabilidad.",
  podiumPolloRateTitle: "Aves por Aparición",
  podiumPolloRateSubtitle: "Pollos por partida. La constancia es una virtud.",
  podiumZapatosTitle: "Filántropo del Calzado",
  podiumZapatosSubtitle: "Más zapatos regalados a la oposición.",
  podiumZapatoRateTitle: "Zapatos per Cápita",
  podiumZapatoRateSubtitle: "Tasa de zapatos. Pisa suave, pega duro.",
  podiumGamesTitle: "Campeón del Excel",
  podiumGamesSubtitle: "Más partidas registradas. El volumen es un estilo de vida.",
  podiumHandsTitle: "Dáme Fichas, Para Siempre",
  podiumHandsSubtitle: "Más manos jugadas. Las fichas ya saben tu nombre.",
  podiumBestLoserTitle: "Mejor Perdedor",
  podiumBestLoserSubtitle: "Más partidas perdidas. Participación en la derrota.",
  ...
  podiumPollosEatenSubtitle: "Más pollos recibidos. Pollo gratis, dignidad cara.",
  podiumZapatosEatenTitle: "Paseo de la Vergüenza",
  podiumZapatosEatenSubtitle: "Más zapatos coleccionados. Derrota con estilo.",
